    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {forgotPasswordNotice && (
          <div className="p-3 bg-stone-50 dark:bg-[#0c120e] border border-stone-200 dark:border-emerald-950/70 rounded-xl text-xs text-stone-700 dark:text-stone-300 flex items-start justify-between gap-2 animate-fade-in-up">
            <span>For password resets, contact your administrator or re-create an account.</span>
            <button
              type="button"
              onClick={() => setForgotPasswordNotice(false)}
              className="text-stone-500 hover:text-stone-900 dark:hover:text-white font-bold px-1 shrink-0"
            >
              ✕
            </button>
          </div>
